...
This ¡¥s a simple way for user to implement the model of content-based of recommender system. We will use Python to illustrate the following. Basically, Content -Based Filtering is going to find the missing value with the recommender system.  
