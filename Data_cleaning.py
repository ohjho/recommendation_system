...
df_books = pd.read_csv(
    "BX-Books.csv", sep=';', encoding="ISO-8859-1", error_bad_lines=False
)
df_users = pd.read_csv("BX-Users.csv", sep=';', encoding="ISO-8859-1")
df_ratings = pd.read_csv(
    "BX-Book-Ratings.csv", sep=';', encoding="ISO-8859-1"
)
df_books.columns = [
...
# anything > 2018 doesn't make sense and they should be
# null too
df_books.pub_year[
